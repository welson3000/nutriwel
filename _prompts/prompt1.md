...
Você vai criar o banco de dados para um sistema de gestão para nutricionistas. Você tem acesso ao Neon via MCP e o projeto já foi criado com o nome de "nutriwel" Project ID: “sparkling-morning-84769984”. Então pode e deve criar toda a estrutura diretamente via MCP, sem necessidade de copiar SQL manualmente.
